...
CREATE TABLE `pager` (
  `totolPage` int(11) DEFAULT NULL,
  `currentPage` int(11) DEFAULT NULL,
  `pageSize` int(11) NOT NULL,
  `limitMin` int(11) DEFAULT NULL,
  `flag` int(2) DEFAULT NULL,
  PRIMARY KEY (`pageSize`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of pager
-- ----------------------------
INSERT INTO `pager` VALUES ('3', '1', '4', '1', '1');
INSERT INTO `pager` VALUES (null, '1', '8', '1', '0');
INSERT INTO `pager` VALUES (null, '1', '16', '1', '0');
