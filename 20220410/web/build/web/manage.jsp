...
<center>
    ...
    <table border bordercolor= "#0099FF">
        <tr><th colspan ="3" bgcolor ='#CCEEEE'>删除投票选项</th>
                <% ResultSet rs = db.executeQuery("select * from vote");
                    ...
                    db.close();
                %>
        <tr><th colspan="3" bgcolor='#CCEEEE'>添加投票选项</th>
        <tr><td colspan="3">
        ...
        <tr><td colspen="3" align="center" bgoolor='#CCFEE'><a href = "vote.jsp">返回投票页面</a></td>
    </table>
</center>